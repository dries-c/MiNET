...
namespace TestPlugin.NiceLobby
{
	...
	public class NiceLobbyPlugin : Plugin
	{
		...
		private void OnPlayerJoin(object o, PlayerEventArgs eventArgs)
		{
			...
			//player.Inventory.Slots[idx++] = new ItemSapling() { Count = 64 };
			//player.Inventory.Slots[idx++] = new ItemSapling() { Count = 64 };
			//player.Inventory.Slots[idx++] = new ItemVine() { Count = 64 };
			//player.Inventory.Slots[idx++] = new ItemSnowLayer() {Count = 64};
			//player.Inventory.Slots[idx++] = new ItemDirt() {Count = 64};
			//player.Inventory.Slots[idx++] = new ItemWoodenButton() { Count = 64 };
			...
			//player.Inventory.Slots[idx++] = new ItemTorch() {Count = 64};
			//player.Inventory.Slots[idx++] = new ItemStone() {Count = 64};
